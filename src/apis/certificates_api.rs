...
pub async fn delete_certificate(configuration: &configuration::Configuration, params: DeleteCertificateParams) -> Result<(), Error<DeleteCertificateError>> {
    ...
    let local_var_uri_str = format!("{}/certificates/{id}", configuration.base_path, id=id);
...
pub async fn get_action_for_certificate(configuration: &configuration::Configuration, params: GetActionForCertificateParams) -> Result<crate::models::GetActionForCertificateResponse, Error<GetActionForCertificateError>> {
    // unbox the parameters
    let id = params.id;
    ...
    let local_var_uri_str = format!("{}/certificates/{id}/actions/{action_id}", configuration.base_path, id=id, action_id=action_id);
...
pub async fn list_actions_for_certificate(configuration: &configuration::Configuration, params: ListActionsForCertificateParams) -> Result<crate::models::ListActionsForCertificateResponse, Error<ListActionsForCertificateError>> {
    // unbox the parameters
    let id = params.id;
    ...
    let local_var_uri_str = format!("{}/certificates/{id}/actions", configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn retry_issuance_or_renewal(configuration: &configuration::Configuration, params: RetryIssuanceOrRenewalParams) -> Result<crate::models::RetryIssuanceOrRenewalResponse, Error<RetryIssuanceOrRenewalError>> {
    ...
    let local_var_uri_str = format!("{}/certificates/{id}/actions/retry", configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
