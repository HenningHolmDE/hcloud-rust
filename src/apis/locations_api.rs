...
pub async fn get_location(
    ...
    let local_var_uri_str = format!("{}/locations/{id}", local_base_path, id = id);
...
/// Returns all Locations.  Use the provided URI parameters to modify the result.
pub async fn list_locations(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/locations", local_base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
