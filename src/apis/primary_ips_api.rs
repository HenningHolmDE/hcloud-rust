...
pub struct ChangePrimaryIpProtectionParams {
    /// ID of the Primary IP
    pub id: i64,
    pub change_primary_ip_protection_request: Option<models::ChangePrimaryIpProtectionRequest>,
}
...
pub struct ChangeReverseDnsEntryForPrimaryIpParams {
    ...
    pub change_reverse_dns_entry_for_primary_ip_request:
        Option<models::ChangeReverseDnsEntryForPrimaryIpRequest>,
}
...
pub async fn change_reverse_dns_entry_for_primary_ip(
    ...
    models::ChangeReverseDnsEntryForPrimaryIpResponse,
