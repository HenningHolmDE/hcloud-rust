...
pub struct AttachLoadBalancerToNetworkParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub attach_load_balancer_to_network_request: models::AttachLoadBalancerToNetworkRequest,
}
...
pub struct ChangeAlgorithmParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub body: models::LoadBalancerAlgorithm,
}
...
pub struct ChangeLoadBalancerProtectionParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub change_load_balancer_protection_request: models::ChangeLoadBalancerProtectionRequest,
}
...
pub struct ChangeReverseDnsEntryForThisLoadBalancerParams {
    ...
    pub change_reverse_dns_entry_for_this_load_balancer_request:
        models::ChangeReverseDnsEntryForThisLoadBalancerRequest,
}
...
pub struct ChangeTypeOfLoadBalancerParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub change_type_of_load_balancer_request: models::ChangeTypeOfLoadBalancerRequest,
}

/// struct for passing parameters to the method [`create_load_balancer`]
#[derive(Clone, Debug, Default)]
pub struct CreateLoadBalancerParams {
    pub create_load_balancer_request: models::CreateLoadBalancerRequest,
}
...
pub struct DeleteServiceParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub delete_service_request: models::DeleteServiceRequest,
}
...
pub struct DetachLoadBalancerFromNetworkParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub detach_load_balancer_from_network_request: models::DetachLoadBalancerFromNetworkRequest,
}
...
/// struct for passing parameters to the method [`list_load_balancer_actions`]
#[derive(Clone, Debug, Default)]
pub struct ListLoadBalancerActionsParams {
...
pub struct RemoveTargetParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub remove_target_request: models::RemoveTargetRequest,
}
...
pub struct ReplaceLoadBalancerParams {
    /// ID of the Load Balancer.
    pub id: i64,
    pub replace_load_balancer_request: models::ReplaceLoadBalancerRequest,
}
...
/// struct for typed errors of method [`get_load_balancer_action`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLoadBalancerActionError {
    Status4xx(models::ErrorResponse),
    Status5xx(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`list_load_balancer_actions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListLoadBalancerActionsError {
    Status4xx(models::ErrorResponse),
    Status5xx(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// Adds a service to a Load Balancer.  #### Operation specific errors  | Status | Code | Description | | --- | --- | --- | |  | `source_port_already_used` | The source port you are trying to add is already in use |
...
/// Adds a target to a Load Balancer.  #### Operation specific errors  | Status | Code | Description | | --- | --- | --- | |  | `cloud_resource_ip_not_allowed` | The IP you are trying to add as a target belongs to a Hetzner Cloud resource | |  | `ip_not_owned` | The IP you are trying to add as a target is not owned by the Project owner | |  | `load_balancer_public_interface_disabled` | The Load Balancer's public network interface is disabled | |  | `load_balancer_not_attached_to_network` | The Load Balancer is not attached to a network | |  | `robot_unavailable` | Robot was not available. The caller may retry the operation after a short delay. | |  | `server_not_attached_to_network` | The server you are trying to add as a target is not attached to the same network as the Load Balancer | |  | `missing_ipv4` | The server that you are trying to add as a public target does not have a public IPv4 address | |  | `target_already_defined` | The Load Balancer target you are trying to define is already defined |
...
/// Changes the type (Max Services, Max Targets and Max Connections) of a Load Balancer.  #### Operation specific errors  | Status | Code | Description | | --- | --- | --- | |  | `invalid_load_balancer_type` | The Load Balancer type does not fit for the given Load Balancer |
...
/// Updates a Load Balancer Service.  #### Operation specific errors  | Status | Code | Description | | --- | --- | --- | |  | `source_port_already_used` | The source port you are trying to add is already in use |
