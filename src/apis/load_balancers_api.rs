...
pub struct UpdateServiceParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub body: Option<crate::models::UpdateLoadBalancerService>,
}
...
) -> Result<crate::models::GetActionResponse, Error<GetLoadBalancerActionError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ListActionsResponse, Error<ListLoadBalancerActionsError>> {
    let local_var_configuration = configuration;
