...
pub struct AddServiceParams {
    ...
    pub id: i64,
    pub body: Option<models::LoadBalancerService>,
}
...
pub struct AddTargetParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub add_target_request: Option<models::AddTargetRequest>,
}
...
pub struct AttachLoadBalancerToNetworkParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub attach_load_balancer_to_network_request: Option<models::AttachLoadBalancerToNetworkRequest>,
}
...
pub struct ChangeAlgorithmParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub body: Option<models::LoadBalancerAlgorithm>,
}
...
pub struct ChangeLoadBalancerProtectionParams {
    ...
    pub change_load_balancer_protection_request:
        Option<models::ChangeLoadBalancerProtectionRequest>,
}
...
pub struct ChangeReverseDnsEntryForThisLoadBalancerParams {
    ...
    pub change_reverse_dns_entry_for_this_load_balancer_request:
        Option<models::ChangeReverseDnsEntryForThisLoadBalancerRequest>,
}
...
pub struct ChangeTypeOfLoadBalancerParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub change_type_of_load_balancer_request: Option<models::ChangeTypeOfLoadBalancerRequest>,
}

/// struct for passing parameters to the method [`create_load_balancer`]
#[derive(Clone, Debug, Default)]
pub struct CreateLoadBalancerParams {
    pub create_load_balancer_request: Option<models::CreateLoadBalancerRequest>,
}
...
pub struct DeleteServiceParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub delete_service_request: Option<models::DeleteServiceRequest>,
}
...
pub struct DetachLoadBalancerFromNetworkParams {
    ...
    pub detach_load_balancer_from_network_request:
        Option<models::DetachLoadBalancerFromNetworkRequest>,
}
...
pub struct RemoveTargetParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub remove_target_request: Option<models::RemoveTargetRequest>,
}
...
pub struct ReplaceLoadBalancerParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub replace_load_balancer_request: Option<models::ReplaceLoadBalancerRequest>,
}
...
pub struct UpdateServiceParams {
    /// ID of the Load Balancer
    pub id: i64,
    pub body: Option<models::UpdateLoadBalancerService>,
}
