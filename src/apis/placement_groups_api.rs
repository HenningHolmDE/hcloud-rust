...
pub struct CreatePlacementgroupParams {
    pub create_placementgroup_request: models::CreatePlacementgroupRequest,
}
...
pub struct ReplacePlacementgroupParams {
    /// ID of the Placement Group.
    pub id: i64,
    pub replace_placementgroup_request: models::ReplacePlacementgroupRequest,
}
...
pub async fn create_placementgroup(
    ...
    let local_var_uri_str = format!("{}/placement_groups", local_base_path);
...
pub async fn delete_placementgroup(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/placement_groups/{id}", local_base_path, id = id);
    let mut local_var_req_builder =
