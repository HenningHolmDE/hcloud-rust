...
pub async fn create_placementgroup(configuration: &configuration::Configuration, params: CreatePlacementgroupParams) -> Result<crate::models::CreatePlacementgroupResponse, Error<CreatePlacementgroupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePlacementgroupError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_placementgroup(configuration: &configuration::Configuration, params: DeletePlacementgroupParams) -> Result<(), Error<DeletePlacementgroupError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/placement_groups/{id}", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePlacementgroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_placementgroup(configuration: &configuration::Configuration, params: GetPlacementgroupParams) -> Result<crate::models::GetPlacementgroupResponse, Error<GetPlacementgroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlacementgroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_placementgroups(configuration: &configuration::Configuration, params: ListPlacementgroupsParams) -> Result<crate::models::ListPlacementgroupsResponse, Error<ListPlacementgroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPlacementgroupsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn replace_placementgroup(configuration: &configuration::Configuration, params: ReplacePlacementgroupParams) -> Result<crate::models::ReplacePlacementgroupResponse, Error<ReplacePlacementgroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReplacePlacementgroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
