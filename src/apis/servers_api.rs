...
pub struct AddServerToPlacementGroupParams {
    /// ID of the Server.
    pub id: i64,
    pub add_server_to_placement_group_request: Option<models::AddServerToPlacementGroupRequest>,
}
...
pub struct AttachIsoToServerParams {
    /// ID of the Server.
    pub id: i64,
    pub attach_iso_to_server_request: Option<models::AttachIsoToServerRequest>,
}
...
pub struct AttachServerToNetworkParams {
    /// ID of the Server.
    pub id: i64,
    pub attach_server_to_network_request: Option<models::AttachServerToNetworkRequest>,
}
...
pub struct ChangeAliasIpsOfNetworkParams {
    /// ID of the Server.
    pub id: i64,
    pub change_alias_ips_of_network_request: Option<models::ChangeAliasIpsOfNetworkRequest>,
}
...
pub struct ChangeReverseDnsEntryForThisServerParams {
    ...
    pub change_reverse_dns_entry_for_this_server_request:
        Option<models::ChangeReverseDnsEntryForThisServerRequest>,
}
...
pub struct ChangeServerProtectionParams {
    /// ID of the Server.
    pub id: i64,
    pub change_server_protection_request: Option<models::ChangeServerProtectionRequest>,
}
...
pub struct ChangeTypeOfServerParams {
    /// ID of the Server.
    pub id: i64,
    pub change_type_of_server_request: Option<models::ChangeTypeOfServerRequest>,
}
...
pub struct CreateImageFromServerParams {
    /// ID of the Server.
    pub id: i64,
    pub create_image_from_server_request: Option<models::CreateImageFromServerRequest>,
}
...
pub struct CreateServerParams {
    ...
    pub create_server_request: Option<models::CreateServerRequest>,
}
...
pub struct DetachServerFromNetworkParams {
    /// ID of the Server.
    pub id: i64,
    pub detach_server_from_network_request: Option<models::DetachServerFromNetworkRequest>,
}
...
pub struct EnableRescueModeForServerParams {
    /// ID of the Server.
    pub id: i64,
    pub enable_rescue_mode_for_server_request: Option<models::EnableRescueModeForServerRequest>,
}
...
pub struct RebuildServerFromImageParams {
    ...
    pub rebuild_server_from_image_request: Option<models::RebuildServerFromImageRequest>,
}
...
pub struct ReplaceServerParams {
    /// ID of the Server.
    pub id: i64,
    pub replace_server_request: Option<models::ReplaceServerRequest>,
}
