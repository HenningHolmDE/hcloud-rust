...
pub struct AddServerToPlacementGroupParams {
    /// ID of the Server
    pub id: i32,
    pub add_server_to_placement_group_request: Option<crate::models::AddServerToPlacementGroupRequest>
}
...
pub async fn add_server_to_placement_group(configuration: &configuration::Configuration, params: AddServerToPlacementGroupParams) -> Result<crate::models::AddServerToPlacementGroupResponse, Error<AddServerToPlacementGroupError>> {
    ...
    let local_var_uri_str = format!("{}/servers/{id}/actions/add_to_placement_group", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddServerToPlacementGroupError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn remove_from_placement_group(configuration: &configuration::Configuration, params: RemoveFromPlacementGroupParams) -> Result<crate::models::RemoveFromPlacementGroupResponse, Error<RemoveFromPlacementGroupError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/servers/{id}/actions/remove_from_placement_group", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveFromPlacementGroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
