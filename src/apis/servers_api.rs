...
pub struct AddServerToPlacementGroupParams {
    /// ID of the Server.
    pub id: i64,
    pub add_server_to_placement_group_request: models::AddServerToPlacementGroupRequest,
}
...
pub struct AttachIsoToServerParams {
    /// ID of the Server.
    pub id: i64,
    pub attach_iso_to_server_request: models::AttachIsoToServerRequest,
}
...
pub struct AttachServerToNetworkParams {
    /// ID of the Server.
    pub id: i64,
    pub attach_server_to_network_request: models::AttachServerToNetworkRequest,
}
...
pub struct ChangeAliasIpsOfNetworkParams {
    /// ID of the Server.
    pub id: i64,
    pub change_alias_ips_of_network_request: models::ChangeAliasIpsOfNetworkRequest,
}
...
pub struct ChangeReverseDnsEntryForThisServerParams {
    ...
    pub change_reverse_dns_entry_for_this_server_request:
        models::ChangeReverseDnsEntryForThisServerRequest,
}
...
pub struct ChangeServerProtectionParams {
    /// ID of the Server.
    pub id: i64,
    pub change_server_protection_request: models::ChangeServerProtectionRequest,
}
...
pub struct ChangeTypeOfServerParams {
    /// ID of the Server.
    pub id: i64,
    pub change_type_of_server_request: models::ChangeTypeOfServerRequest,
}
...
pub struct CreateImageFromServerParams {
    /// ID of the Server.
    pub id: i64,
    pub create_image_from_server_request: models::CreateImageFromServerRequest,
}
...
pub struct CreateServerParams {
    ...
    pub create_server_request: models::CreateServerRequest,
}
...
pub struct DetachServerFromNetworkParams {
    /// ID of the Server.
    pub id: i64,
    pub detach_server_from_network_request: models::DetachServerFromNetworkRequest,
}
...
pub struct EnableRescueModeForServerParams {
    /// ID of the Server.
    pub id: i64,
    pub enable_rescue_mode_for_server_request: models::EnableRescueModeForServerRequest,
}
...
/// struct for passing parameters to the method [`list_server_actions`]
#[derive(Clone, Debug, Default)]
...
pub struct RebuildServerFromImageParams {
    ...
    pub rebuild_server_from_image_request: models::RebuildServerFromImageRequest,
}
...
pub struct ReplaceServerParams {
    /// ID of the Server.
    pub id: i64,
    pub replace_server_request: models::ReplaceServerRequest,
}
...
/// struct for typed errors of method [`get_server_action`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetServerActionError {
    Status4xx(models::ErrorResponse),
    Status5xx(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// Adds a Server to a Placement Group.  Server must be powered off for this command to succeed.  #### Operation specific errors  | Status | Code | Description | | --- | --- | --- | |  | `server_not_stopped` | The action requires a stopped server |
...
/// Creates a new Server. Returns preliminary information about the Server as well as an Action that covers progress of creation.  #### Operation specific errors  | Status | Code | Description | | --- | --- | --- | |  | `placement_error` | An error during the placement occurred | |  | `primary_ip_assigned` | The specified Primary IP is already assigned to a server | |  | `primary_ip_datacenter_mismatch` | he specified Primary IP is in a different datacenter | |  | `primary_ip_version_mismatch` | The specified Primary IP has the wrong IP Version |
