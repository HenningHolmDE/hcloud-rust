...
pub struct ChangeImageProtectionParams {
    /// ID of the Image.
    pub id: i64,
    pub change_image_protection_request: Option<models::ChangeImageProtectionRequest>,
}
...
pub struct ReplaceImageParams {
    /// ID of the Image.
    pub id: i64,
    pub replace_image_request: Option<models::ReplaceImageRequest>,
}
...
pub async fn delete_image(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/images/{id}", local_base_path, id = id);
    let mut local_var_req_builder =
...
pub async fn get_image_action(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/images/actions/{id}", local_base_path, id = id);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_actions_for_image(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/images/{id}/actions", local_base_path, id = id);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_image_actions(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/images/actions", local_base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_images(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/images", local_base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = bound_to {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .iter()
                    .map(|p| ("bound_to".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "bound_to",
