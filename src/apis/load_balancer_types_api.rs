...
pub async fn get_load_balancer_type(
...
) -> Result<models::GetLoadBalancerTypeResponse, Error<GetLoadBalancerTypeError>> {
    ...
    let local_var_uri_str = format!("{}/load_balancer_types/{id}", local_base_path, id = id);
...
pub async fn list_load_balancer_types(
...
) -> Result<models::ListLoadBalancerTypesResponse, Error<ListLoadBalancerTypesError>> {
    let local_var_configuration = configuration;
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/load_balancer_types", local_base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
