...
pub struct AttachVolumeToServerParams {
    /// ID of the Volume.
    pub id: i64,
    pub attach_volume_to_server_request: Option<models::AttachVolumeToServerRequest>,
}
...
pub struct ChangeVolumeProtectionParams {
    /// ID of the Volume.
    pub id: i64,
    pub change_volume_protection_request: Option<models::ChangeVolumeProtectionRequest>,
}

/// struct for passing parameters to the method [`create_volume`]
#[derive(Clone, Debug, Default)]
pub struct CreateVolumeParams {
    pub create_volume_request: Option<models::CreateVolumeRequest>,
}
...
pub struct ReplaceVolumeParams {
    /// ID of the Volume.
    pub id: i64,
    pub replace_volume_request: Option<models::ReplaceVolumeRequest>,
}
...
pub struct ResizeVolumeParams {
    /// ID of the Volume.
    pub id: i64,
    pub resize_volume_request: Option<models::ResizeVolumeRequest>,
}
