...
pub struct AttachVolumeToServerParams {
    /// ID of the Volume.
    pub id: i64,
    pub attach_volume_to_server_request: models::AttachVolumeToServerRequest,
}
...
pub struct ChangeVolumeProtectionParams {
    /// ID of the Volume.
    pub id: i64,
    pub change_volume_protection_request: models::ChangeVolumeProtectionRequest,
}

/// struct for passing parameters to the method [`create_volume`]
#[derive(Clone, Debug, Default)]
pub struct CreateVolumeParams {
    pub create_volume_request: models::CreateVolumeRequest,
}
...
pub struct ReplaceVolumeParams {
    /// ID of the Volume.
    pub id: i64,
    pub replace_volume_request: models::ReplaceVolumeRequest,
}
...
pub struct ResizeVolumeParams {
    /// ID of the Volume.
    pub id: i64,
    pub resize_volume_request: models::ResizeVolumeRequest,
}
