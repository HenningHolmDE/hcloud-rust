...
pub struct ApplyToResourcesParams {
    /// ID of the Firewall.
    pub id: i64,
    pub apply_to_resources_request: models::ApplyToResourcesRequest,
}

/// struct for passing parameters to the method [`create_firewall`]
#[derive(Clone, Debug, Default)]
pub struct CreateFirewallParams {
    pub create_firewall_request: models::CreateFirewallRequest,
}
...
pub struct RemoveFromResourcesParams {
    /// ID of the Firewall.
    pub id: i64,
    pub remove_from_resources_request: models::RemoveFromResourcesRequest,
}
...
pub struct ReplaceFirewallParams {
    /// ID of the Firewall.
    pub id: i64,
    pub replace_firewall_request: models::ReplaceFirewallRequest,
}
...
pub struct SetRulesParams {
    /// ID of the Firewall.
    pub id: i64,
    pub set_rules_request: models::SetRulesRequest,
}
...
pub async fn create_firewall(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/firewalls", local_base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn delete_firewall(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/firewalls/{id}", local_base_path, id = id);
    let mut local_var_req_builder =
...
pub async fn get_firewall_action(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/firewalls/actions/{id}", local_base_path, id = id);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_actions_for_firewall(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/firewalls/{id}/actions", local_base_path, id = id);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_firewall_actions(
    ...
    let local_base_path = local_var_configuration.get_base_path("https://api.hetzner.cloud/v1");
    let local_var_uri_str = format!("{}/firewalls/actions", local_base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
