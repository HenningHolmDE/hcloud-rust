...
pub struct ChangeFloatingIpProtectionParams {
    /// ID of the Floating IP
    pub id: i64,
    pub change_floating_ip_protection_request: Option<models::ChangeFloatingIpProtectionRequest>,
}
...
pub struct ChangeReverseDnsEntryForFloatingIpParams {
    ...
    pub change_reverse_dns_entry_for_floating_ip_request:
        Option<models::ChangeReverseDnsEntryForFloatingIpRequest>,
}
...
pub async fn change_reverse_dns_entry_for_floating_ip(
    ...
    models::ChangeReverseDnsEntryForFloatingIpResponse,
