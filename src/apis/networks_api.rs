...
pub struct ChangeIpRangeOfNetworkParams {
    /// ID of the Network.
    pub id: i64,
    pub change_ip_range_of_network_request: Option<models::ChangeIpRangeOfNetworkRequest>,
}
...
pub struct ChangeNetworkProtectionParams {
    /// ID of the Network.
    pub id: i64,
    pub change_network_protection_request: Option<models::ChangeNetworkProtectionRequest>,
}

/// struct for passing parameters to the method [`create_network`]
#[derive(Clone, Debug, Default)]
pub struct CreateNetworkParams {
    pub create_network_request: Option<models::CreateNetworkRequest>,
}
...
pub struct DeleteSubnetFromNetworkParams {
    /// ID of the Network.
    pub id: i64,
    pub delete_subnet_from_network_request: Option<models::DeleteSubnetFromNetworkRequest>,
}
...
pub struct ReplaceNetworkParams {
    /// ID of the Network.
    pub id: i64,
    pub replace_network_request: Option<models::ReplaceNetworkRequest>,
}
...
pub async fn list_network_actions(
    ...
    let local_var_uri_str = format!("{}/networks/actions", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
