...
impl FloatingIp {
    pub fn new(id: i32, name: String, description: Option<String>, ip: String, _type: Type, server: Option<i32>, dns_ptr: Vec<crate::models::DnsPtr>, home_location: crate::models::Location, blocked: bool, protection: crate::models::Protection, labels: ::std::collections::HashMap<String, String>, created: String) -> FloatingIp {
        FloatingIp {
            id,
            name,
            description,
