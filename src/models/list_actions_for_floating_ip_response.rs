...
/// ListActionsForFloatingIpResponse : Response to GET https://api.hetzner.cloud/v1/floating_ips/{id}/actions{?status,sort}
...
impl ListActionsForFloatingIpResponse {
    /// Response to GET https://api.hetzner.cloud/v1/floating_ips/{id}/actions{?status,sort}
