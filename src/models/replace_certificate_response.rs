...
pub struct ReplaceCertificateResponse {
    ...
    pub certificate: crate::models::ReplaceCertificateResponseCertificate,
}

impl ReplaceCertificateResponse {
    /// Response to PUT https://api.hetzner.cloud/v1/certificates/{id}
    pub fn new(certificate: crate::models::ReplaceCertificateResponseCertificate) -> ReplaceCertificateResponse {
