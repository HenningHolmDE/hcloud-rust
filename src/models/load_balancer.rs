...
impl LoadBalancer {
    pub fn new(id: i32, name: String, public_net: crate::models::LoadBalancerPublicNet, private_net: Vec<serde_json::Value>, location: crate::models::Location, load_balancer_type: crate::models::LoadBalancerType, protection: crate::models::LoadBalancerProtection, labels: ::std::collections::HashMap<String, String>, created: String, services: Vec<crate::models::Service>, targets: Vec<crate::models::Target>, algorithm: crate::models::LoadBalancerAlgorithm, outgoing_traffic: Option<i64>, ingoing_traffic: Option<i64>, included_traffic: i64) -> LoadBalancer {
        LoadBalancer {
            id,
            name,
            public_net,
