...
/// ServerTypeNoArchitecture : Type of Server - determines how much ram, disk and cpu a Server has

#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ServerTypeNoArchitecture {
