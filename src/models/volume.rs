...
impl Volume {
    pub fn new(id: i32, created: String, name: String, server: Option<i32>, location: crate::models::Location, size: f32, linux_device: String, protection: crate::models::ReplaceVolumeResponseVolumeProtection, labels: serde_json::Value, status: Status, format: Option<String>) -> Volume {
        Volume {
            id,
            created,
            name,
