...
pub mod list_prices_response_pricing_primary_ips_inner;
pub use self::list_prices_response_pricing_primary_ips_inner::ListPricesResponsePricingPrimaryIpsInner;
