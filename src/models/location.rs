...
/// Location : Location the Data Center is located at.  | Location of the Volume. Volume can only be attached to Servers in the same Location.
...
impl Location {
    /// Location the Data Center is located at.  | Location of the Volume. Volume can only be attached to Servers in the same Location.
    pub fn new(
        city: String,
        country: String,
        description: String,
